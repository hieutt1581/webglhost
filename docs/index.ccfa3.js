System.register(["./application.eae0c.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_applicationEae0cJs) {
      createApplication = _applicationEae0cJs.createApplication;
    }],
    execute: function () {
      createApplication({
